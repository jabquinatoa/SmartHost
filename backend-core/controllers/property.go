...
func SeedProperties(c *fiber.Ctx) error {
	...
	properties := []models.Property{
		{
			AnfitrionID: 1, Name: "Loft Moderno Parque La Carolina", Location: "La Carolina, Quito Norte", Price: 65, Rating: 4.9, Reviews: 128, Type: "Lofts", Capacity: 4, Image: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&h=800&fit=crop",
		...
		{
			AnfitrionID: 1, Name: "Casa Patrimonial Restaurada", Location: "Centro Histórico, Quito Centro", Price: 85, Rating: 4.8, Reviews: 89, Type: "Casas", Capacity: 6, Image: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&h=800&fit=crop",
		...
		{
			AnfitrionID: 1, Name: "Suite Ejecutiva frente al CCI", Location: "La Carolina, Quito Norte", Price: 90, Rating: 5.0, Reviews: 64, Type: "Suites", Capacity: 2, Image: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&h=800&fit=crop",
		...
		{
			AnfitrionID: 1, Name: "Departamento Moderno El Recreo", Location: "El Recreo, Quito Sur", Price: 55, Rating: 4.7, Reviews: 42, Type: "Departamentos", Capacity: 4, Image: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800&h=800&fit=crop",
		...
		{
			AnfitrionID: 1, Name: "Departamento Familiar Solanda", Location: "Solanda, Quito Sur", Price: 45, Rating: 4.6, Reviews: 38, Type: "Departamentos", Capacity: 5, Image: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&h=800&fit=crop",
		...
		{
			AnfitrionID: 1, Name: "Loft Industrial Quitumbe", Location: "Quitumbe, Quito Sur", Price: 50, Rating: 4.9, Reviews: 15, Type: "Lofts", Capacity: 2, Image: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&h=800&fit=crop",
		...
		{
			AnfitrionID: 1, Name: "Casa de Retiro con Jardín", Location: "Cumbayá, Valles", Price: 150, Rating: 5.0, Reviews: 64, Type: "Casas", Capacity: 8, Image: "https://images.unsplash.com/photo-1518780664697-55e3ad937233?auto=format&fit=crop&w=800&q=80",
		...
		{
			AnfitrionID: 1, Name: "Suite Minimalista Ejecutiva", Location: "Bellavista, Quito Norte", Price: 45, Rating: 4.8, Reviews: 156, Type: "Suites", Capacity: 2, Image: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=800&q=80",
		...
		{
			AnfitrionID: 1, Name: "Loft con Terraza Privada", Location: "La Floresta, Quito Centro", Price: 75, Rating: 4.9, Reviews: 112, Type: "Lofts", Capacity: 2, Image: "https://images.unsplash.com/photo-1502672023488-70e25813eb80?auto=format&fit=crop&w=800&q=80",
		...
		{
			AnfitrionID: 1, Name: "Penthouse de Lujo", Location: "González Suárez, Quito Norte", Price: 180, Rating: 5.0, Reviews: 42, Type: "Departamentos", Capacity: 6, Image: "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?auto=format&fit=crop&w=800&q=80",
		...
		{
			AnfitrionID: 1, Name: "Villa Moderna con Piscina", Location: "Tumbaco, Valles", Price: 220, Rating: 4.9, Reviews: 58, Type: "Casas", Capacity: 10, Image: "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&w=800&q=80",
		...
		{
			AnfitrionID: 1, Name: "Suite Boutique Temática", Location: "La Mariscal, Quito Centro", Price: 50, Rating: 4.5, Reviews: 78, Type: "Suites", Capacity: 2, Image: "https://images.unsplash.com/photo-1536376072261-38c75010e6c9?w=800&h=800&fit=crop",
		...
		{
			AnfitrionID: 1, Name: "Piso Moderno y Céntrico", Location: "La Magdalena, Quito Sur", Price: 70, Rating: 4.6, Reviews: 92, Type: "Departamentos", Capacity: 5, Image: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=800&q=80",
		...
		{
			AnfitrionID: 1, Name: "Casa Histórica San Marcos", Location: "San Marcos, Quito Centro", Price: 90, Rating: 4.9, Reviews: 205, Type: "Casas", Capacity: 5, Image: "https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?auto=format&fit=crop&w=800&q=80",
	...
	for _, p := range properties {
		p.AnfitrionID = 1 // Hardcoded to match the user seeded in users-service
	...
	// Seed Reservations
	res1 := models.Reservation{PropiedadID: 1, HuespedID: 2, MetodoPagoID: 2, PrecioTotal: 150.0, Estado: "Confirmada"}
	res2 := models.Reservation{PropiedadID: 2, HuespedID: 3, MetodoPagoID: 2, PrecioTotal: 300.0, Estado: "Pendiente"}
	db.DB.Create(&res1)
	db.DB.Create(&res2)

	// Print to console so user can see in Docker Desktop
	fmt.Printf("\n--- DATOS DEL CORE CREADOS ---\n")
	fmt.Printf("Propiedades creadas en Catálogo: %d\n", len(properties))
	fmt.Printf("Reservas de prueba creadas: %d\n", 2)
	fmt.Printf("------------------------------\n\n")

	return c.JSON(fiber.Map{"message": "Database seeded successfully with Properties and Reservations!"})
}
