...
export class CatalogoComponent implements OnInit {
  ...
  properties: Property[] = [
    ...
    },
    {
      ...
      type: 'Suites',
      capacity: 2,
      image: 'https://images.unsplash.com/photo-1630699144867-37acec97df15?auto=format&fit=crop&w=800&q=80',
      images: [
        'https://images.unsplash.com/photo-1630699144867-37acec97df15?auto=format&fit=crop&w=1200&q=80',
        'https://images.unsplash.com/photo-1630699144365-2747d79b2eb8?auto=format&fit=crop&w=1200&q=80',
        'https://images.unsplash.com/photo-1630699144431-7b56dcbff8b3?auto=format&fit=crop&w=1200&q=80'
      ],
  ...
  adminContactos: Contacto[] = [
    { id: 1, nombre: "Carlos Martinez", ultimo: "Gracias por la info!", tiempo: "10:40", noLeidos: 2, propiedad: "Loft Moderno", imagen: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=200&h=200&fit=crop", fechas: "15-18 Ene 2026", chat: [] }
  ];
    ...
    if (savedData) {
      try {
        ...
        if (parsed.properties) {
          // Hidratación: Aseguramos que todas las propiedades tengan un arreglo de imágenes válido
